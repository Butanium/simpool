...
# choose test:
mytests = {}
mytests[0] = {"type": "TestAll", "parameters": {}}
mytests[1] = {"type": "TestJustLook", "parameters": {}}
mytests[2] = {
    "type": "TestPool",
    "parameters": {
        ...
        "days_after_negative": 2,
    },  # days after negative test still in quarantine
}
mytests[3] = {
    "type": "TestContacts",
    "parameters": {
        ...
        "days_after_negative": 2,
    },  # after tests are negative, wait another 2 days (check!)
}
...
kerneldist = {
    Category.DOCTOR: {
        Category.DOCTOR: lambda: nbinom.rvs(
            **{"n": 0.639455389646031, "p": 0.33441115478175726}
        ),
        Category.ADMIN: lambda: nbinom.rvs(
            **{"n": 10.000001921571586, "p": 0.990990726325269}
        ),
    ...
    Category.NURSE: {
        ...
        Category.ADMIN: lambda: nbinom.rvs(
            **{"n": 0.15085122247570856, "p": 0.44891340197014196}
        ),
        Category.NURSE: lambda: nbinom.rvs(
            **{"n": 0.4451399065297341, "p": 0.30032845382338796}
        ),
        Category.PATIENT: lambda: nbinom.rvs(
            **{"n": 0.11391011540643767, "p": 0.2352151512186682}
        ),
    },
}
...
contactsdist = {
    Category.DOCTOR: {
        Category.DOCTOR: lambda: nbinom.rvs(
            **{"n": 10.979419508176825, "p": 0.7434157920988455}
        ),
        Category.ADMIN: lambda: nbinom.rvs(
            **{"n": 198.4879963236352, "p": 0.9939559641105772}
        ),
        Category.NURSE: lambda: poisson.rvs(**{"mu": 2.002999988953658}),
        Category.PATIENT: lambda: nbinom.rvs(
            **{"n": 134.7317660804801, "p": 0.987906385925085}
        ),
    },
    Category.NURSE: {
        Category.DOCTOR: lambda: nbinom.rvs(
            **{"n": 143.0480506968438, "p": 0.9896228228165873}
        ),
        Category.ADMIN: lambda: nbinom.rvs(
            **{"n": 174.4605547357785, "p": 0.9920733339719905}
        ),
        Category.NURSE: lambda: nbinom.rvs(
            **{"n": 3.551790950529168, "p": 0.45740247406029183}
        ),
        Category.PATIENT: lambda: nbinom.rvs(
            **{"n": 5.456145786428396, "p": 0.6579607647746138}
        ),
    },
}

contact_length_dist = lambda: lognorm.rvs(
    *(1.4171168017880222, 4.812060883472516, 4.940292742938027)
)
